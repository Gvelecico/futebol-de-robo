...
def  graficos_ax_t(ace_x_ball,ace_x_robot,temp):
    plt.style.use('ggplot')
    
    #Bola
    
    plt.plot(temp, ace_x_ball, color='blue', label='ax bola com T')
    #Robo
    plt.plot(temp, ace_x_robot, color='black', label='ax robo com T')

    plt.xlabel("T")
    plt.ylabel("ax")

    plt.title("Posições de ax e T")

    plt.legend()

    plt.show()

def  graficos_ay_t(ace_y_ball,ace_y_robot,temp):
    plt.style.use('ggplot')
    
    #np.column_stack((temp,ace_y_ball,ace_y_robot))
    #Bola
    plt.plot(temp, ace_y_ball, color='blue', label='ay bola com T')
    #Robo
    plt.plot(temp, ace_y_robot, color='black', label='ay robo com T')

    plt.xlabel("T")
    plt.ylabel("ay")

    plt.title("Posições de ay e T")
